...
## 🔬 Data Scientist Internship - Materials and Structures | Time Series Forecasting
...
Developed and benchmarked supervised learning models for bitumen ageing prediction:
Random Forests
Gradient Boosting (XGBoost, LightGBM, CatBoost)
Recurrent Neural Networks (RNNs)
Time Series Forecasting
Designed data preprocessing and feature engineering pipelines.
Approximated long-term pavement performance using temporal modeling techniques.
